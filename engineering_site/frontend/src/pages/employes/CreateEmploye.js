  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" placeholder="Nom" className="form-control mb-2" onChange={(e) => setNom(e.target.value)} />
        <input type="email" placeholder="Email" className="form-control mb-2" onChange={(e) => setEmail(e.target.value)} />
        <input type="password" placeholder="Mot de passe" className="form-control mb-2" onChange={(e) => setPassword(e.target.value)} />
        <select className="form-control mb-2" onChange={(e) => setRole(e.target.value)}>
          <option value="">Choisir Role</option>
          <option value="Employé">Employé</option>
          <option value="Administrateur">Administrateur</option>
        </select>
        <input type="text" placeholder="Specialite" className="form-control mb-2" onChange={(e) => setSpecialite(e.target.value)} />
